              ...
              {services.map((service, index) => (
                ...
                >
                  ...
                  <div className="p-4 text-center">
                    <h3 className="text-[#e6cfa6]  text-lg md:text-xl text-white font-serif mb-1 tracking-wide">
                      {service.name}
                    </h3>
                ...
                >
                  ...
                  <div className="p-4 text-center">
                    <h3
                      ...
                      className="text-[#e6cfa6] text-lg md:text-xl text-white font-serif mb-1 tracking-wide"
                    >
                      {service.name}
                    </h3>
                    <p className="text-[#d6b981] font-medium">{service.price}</p>
